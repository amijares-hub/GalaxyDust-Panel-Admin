        ...
        <div className="flex-1 overflow-y-auto p-3 space-y-4 custom-scrollbar">
          ...
          <div className="space-y-1">
            ...
            <button
              ...
              className={`w-full flex items-center justify-between px-2.5 py-2 rounded-lg text-left transition-colors cursor-pointer ${
                activeTab === 'can_manager' ? 'bg-red-950/40 text-red-400 border border-red-900/50 font-bold' : 'text-zinc-400 hover:text-white hover:bg-zinc-900/50'
              }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center justify-between px-2.5 py-2 rounded-lg text-left transition-colors cursor-pointer ${
                activeTab === 'user_crm' ? 'bg-red-950/40 text-red-400 border border-red-900/50 font-bold' : 'text-zinc-400 hover:text-white hover:bg-zinc-900/50'
              }`}
            >
            ...
            <div className="space-y-1">
              <button
                ...
                className={`w-full flex items-center justify-between px-2.5 py-2 rounded-lg text-left transition-colors cursor-pointer ${
                  activeTab === 'control_console' || activeTab === 'assets_matrix' ? 'text-red-400 font-bold' : 'text-zinc-400 hover:text-white'
                }`}
              >
              ...
              {isAssetsDropdownOpen && (
                <div className="pl-6 space-y-1 border-l border-zinc-900 ml-3">
                  <button
                    ...
                    className={`w-full text-left py-1.5 px-2 rounded text-[10.5px] cursor-pointer transition-colors ${
                      activeTab === 'control_console' ? 'text-red-500 font-bold bg-red-950/20' : 'text-zinc-500 hover:text-zinc-300'
                    }`}
                  >
                    • Consola de Control
                  </button>
                  <button
                    ...
                    className={`w-full text-left py-1.5 px-2 rounded text-[10.5px] cursor-pointer transition-colors ${
                      activeTab === 'assets_matrix' ? 'text-red-500 font-bold bg-red-950/20' : 'text-zinc-500 hover:text-zinc-300'
                    }`}
                  >
            ...
            <button
              ...
              className={`w-full flex items-center justify-between px-2.5 py-2 rounded-lg text-left transition-colors cursor-pointer ${
                activeTab === 'skill_manager' ? 'bg-red-950/40 text-red-400 border border-red-900/50 font-bold' : 'text-zinc-400 hover:text-white hover:bg-zinc-900/50'
              }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center justify-between px-2.5 py-2 rounded-lg text-left transition-colors cursor-pointer ${
                activeTab === 'expeditions' ? 'bg-red-950/40 text-red-400 border border-red-900/50 font-bold' : 'text-zinc-400 hover:text-white hover:bg-zinc-900/50'
              }`}
            >
          ...
          <div className="space-y-1 pt-2 border-t border-zinc-900">
            ...
            <button
              ...
              className={`w-full flex items-center justify-between px-2.5 py-2 rounded-lg text-left transition-colors cursor-pointer ${
                activeTab === 'marketplace' ? 'bg-red-950/40 text-red-400 border border-red-900/50 font-bold' : 'text-zinc-400 hover:text-white hover:bg-zinc-900/50'
              }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center justify-between px-2.5 py-2 rounded-lg text-left transition-colors cursor-pointer ${
                activeTab === 'phantom_station' ? 'bg-red-950/40 text-red-400 border border-red-900/50 font-bold' : 'text-zinc-400 hover:text-white hover:bg-zinc-900/50'
              }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center justify-between px-2.5 py-2 rounded-lg text-left transition-colors cursor-pointer ${
                activeTab === 'promotions' ? 'bg-red-950/40 text-red-400 border border-red-900/50 font-bold' : 'text-zinc-400 hover:text-white hover:bg-zinc-900/50'
              }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center justify-between px-2.5 py-2 rounded-lg text-left transition-colors cursor-pointer ${
                activeTab === 'alliance_crm' ? 'bg-red-950/40 text-red-400 border border-red-900/50 font-bold' : 'text-zinc-400 hover:text-white hover:bg-zinc-900/50'
              }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center justify-between px-2.5 py-2 rounded-lg text-left transition-colors cursor-pointer ${
                activeTab === 'anticheat' ? 'bg-red-950/40 text-red-400 border border-red-900/50 font-bold' : 'text-zinc-400 hover:text-white hover:bg-zinc-900/50'
              }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center justify-between px-2.5 py-2 rounded-lg text-left transition-colors cursor-pointer ${
                activeTab === 'sanitizer' ? 'bg-red-950/40 text-red-400 border border-red-900/50 font-bold' : 'text-zinc-400 hover:text-white hover:bg-zinc-900/50'
              }`}
            >
